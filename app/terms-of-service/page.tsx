...
export default function TermsOfService() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 text-slate-800 text-sm leading-relaxed">
      <h1 className="text-3xl font-extrabold mb-2 text-slate-900">Terms of Service</h1>
      <p className="text-xs text-slate-500 mb-8">Last Updated: September 18, 2026</p>

      <section className="mb-6">
        <h2 className="text-lg font-bold mb-2 text-slate-900">1. Lead Matching & Broker Status Disclaimer</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-bold mb-2 text-slate-900">2. User Agreement & Authorization</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-bold mb-2 text-slate-900">3. Binding Individual Arbitration & Class Action Waiver</h2>
        <p>
        ...
        <p className="mt-2">
          <strong>30-Day Opt-Out Window:</strong> You have the right to opt out of this arbitration agreement by sending written notice of your decision to <code className="bg-slate-100 px-1 py-0.5 rounded text-xs">dnc@usaroofdamagecheck.com</code> within 30 days of first submitting your information on this site.
        </p>
      </section>

      <section className="mb-6">
        <h2 className="text-lg font-bold mb-2 text-slate-900">4. Limitation of Liability</h2>
        <p>
