    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200 text-slate-800 space-y-6">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Effective September 18, 2026</p>
        </div>
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm text-slate-600">
            ...
            <li>Submit an immediate online suppression request via our <Link href="/revoke" className="text-blue-600 underline font-medium">Revocation Portal (/revoke)</Link>.</li>
            <li>Send an email specifying your phone number to <code className="text-blue-600">dnc@usaroofdamagecheck.com</code>.</li>
          </ul>
          <p className="text-sm leading-relaxed text-slate-600">
