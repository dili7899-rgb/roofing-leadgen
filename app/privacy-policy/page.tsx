      ...
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200 text-slate-800 space-y-6">
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-slate-600">
            We collect personal identification details you voluntarily provide (Name, Phone Number, Email, Property Address, ZIP Code, Storm Damage Details) and technical metadata (IP address, browser type, geographic location, device IDs, dwell time, and interaction timestamps).
          </p>
        </section>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-slate-900 border-b pb-2 border-slate-100">
            4. State Privacy Rights (CCPA/CPRA, TDPSA, VCDPA, SB 140)
          </h2>
          <p className="text-sm leading-relaxed text-slate-600">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm text-slate-600">
            ...
            <li>
              <strong>Opt-Out of Data Sale & Revoke Consent:</strong> You may revoke consent or place your number on our Do Not Call / Suppression list by emailing <code className="bg-slate-100 px-1 py-0.5 rounded text-xs">privacy@usaroofdamagecheck.com</code> with "Do Not Sell My Information" or "REVOKE" in the subject line. Requests are processed instantly via our automated system.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-slate-600">
            Consent metadata, TrustedForm certificates, session audit logs, and cryptographic SHA-256 hashes are securely retained for a minimum of <strong>five (5) years</strong> to strictly adhere to legal requirements under the Telephone Consumer Protection Act (TCPA) and federal regulatory audit limitations.
          </p>
        </section>
